...
export async function login(creds, redirect = "/") {
  try {
    ...
    // Added a redirect to the original URL or default to the homepage (or else after login, it will try to go through /login/index.html, and the images won't work, etc.)
